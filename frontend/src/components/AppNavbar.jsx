...
import { LogOut, Menu, X, Search, Sparkles } from "lucide-react";
          ...
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <button
                ...
                className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-600 text-xs font-semibold transition border border-slate-200"
                title="Open Command Palette (Ctrl+K)"
              >
                <Search size={13} className="text-slate-400" />
                <span>Search</span>
                <kbd className="px-1.5 py-0.5 text-[9px] font-bold bg-white text-slate-500 rounded border border-slate-200">
                  Ctrl K
                </kbd>
              </button>
